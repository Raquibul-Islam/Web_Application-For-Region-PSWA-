...
document.getElementById('chat-form').addEventListener('submit', async function(event) {
    ...
    try {
        const firebaseUrl = `https://web-project1-85433-default-rtdb.firebaseio.com/APi_Data/${encodeURIComponent(messageText)}.json`;
        ...
        if (firebaseData && firebaseData.answer) {
            ...
            const apiResponse = await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyDsjgSK7wL7fAZm6tlKkVVlppb_n02lVXk", {
                method: "POST",
                headers: {
