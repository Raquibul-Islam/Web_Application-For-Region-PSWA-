...
<body>
    <div class="container">
        <h1>Students Info</h1>
        <a href="students_info_form.php" class="add-info-button">Add Your Info</a>
        
        <!-- Sliding text container -->
        <div class="sliding-text-container">
            <p class="sliding-text">If you are a current student, then add your info by clicking the "Add Your Info" button</p>
        </div>
        ...
        <div class="student-container">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<img src='" . $row['image'] . "' alt='Student Photo'>";
                    echo "<h3>" . $row['name'] . "</h3>";
